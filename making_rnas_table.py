...
#   Create the nested dictionary with the counts of each feat type  
    ...
    if counter == {}: #'if dict' doesn't work for an empty defaultdict
        counter['rRNA'] = Counter({'16S ribosomal RNA': 0})
        counter['tRNA'] = Counter({'tRNA-Gly': 0})
    return counter
